...
checkpoint_dir = "/home/cc/CCFs/Wangf/UNPINN/checkpoints/casednnntest"
current_time = datetime.datetime.now().strftime("%Y%m%d-%H%M%S")  # tensorboard准备
save_dir = "/home/cc/CCFs/Wangf/UNPINN/case10pic/testpic5"

result_save_path ="/home/cc/CCFs/Wangf/UNPINN/result_npz/case10/"
...
def train_one_step(step, epoch, train_h, train_xyt):
    ...
    with tf.GradientTape() as tape:
        loss_mse = LossBdLogits(train_h, train_xyt)

        # 总损失
        total_loss = lambda1 * loss_mse  
...
def main():
    ...
    for epoch in range(1,epochs+1):  # epoch数量
        ...
        for step, (train_xyt, train_h) in enumerate(db):
            ...
            total_loss, loss_mse = train_one_step(
        ...
        plot_compared_heatmaps_3pic6(lc_xy, 10*test_h, 10*logits, epoch, save_dir, current_time)
