...
heads10_fn = '/home/cc/CCFs/Wangf/UNPINN/modflow/case_study_10/heads.dat'
NC = 51
NR = 51
time_step_num = 50
        
# read the heads from 'heads.dat'
heads10_data = read_heads_dat(NC, NR, heads10_fn, time_step_num)  
...
def get_data():
    ...
    if 0:  # generate the training dataset and validation dataset. Only use for once.
        ...
        # read the heads from 'heads.dat'
        heads_data = read_heads_dat(NC, NR, heads10_fn, time_step_num)
        ...
        np.savez('/home/cc/CCFs/Wangf/UNPINN/makedata/getdata_10/3.10_example.npz', k_heads_data=heads_data, k_rand_pos=rand_pos,
        ...
        data0 = np.load(
            '/home/cc/CCFs/Wangf/UNPINN/makedata/getdata_10/3.10_example.npz')
    ...
    if 0:  # 得到0-17数据集
        ...
        np.savez('/home/cc/CCFs/Wangf/UNPINN/makedata/getdata_10/3.10_reshape.npz', k_train_xyt=train_xyt,
                 k_train_h=train_h, k_pre_xyt=pre_xyt, k_pre_h=pre_h)
    else:  # 获取0-17xyt——h训练集与18-50测试集
        data1 = np.load(
            '/home/cc/CCFs/Wangf/UNPINN/makedata/getdata_10/3.10_reshape.npz')
