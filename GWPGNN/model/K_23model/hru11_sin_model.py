...
checkpoint_save_path = "/home/cc/CCFs/Wangf/GWPGNN/checkpoints/hru1/hru1_weights_sin.ckpt"
...
save_dir = './pics/hru1_k_23/val_pics_k_23/2024_6_20_sin'  # 存放验证图片的路径
...
def plot_loss(epochs, total_losses,train_losses, val_losses):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'{save_dir_loss}/loss_sin{current_time}.png')
